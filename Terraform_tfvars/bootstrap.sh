...
ansible-pull -U https://github.com/hari-palepu/11_Roboshop_ansible_roles_tf.git -e host_name=$host_name -e env=$environment -e app_version=$app_version main_tf.yaml
